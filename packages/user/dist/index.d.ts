...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CDYIABWQ564YH2NBAHH4IIBNOIJVYQQEE7VO6FNFHKQLVSFWV7KKAAV6";
    };
};
export type DataKey = {
    tag: "User";
...
export declare const UserError: {
    1: {
        message: string;
    };
    2: {
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        is_user: (json: string) => AssembledTransaction<boolean>;
    };
}
